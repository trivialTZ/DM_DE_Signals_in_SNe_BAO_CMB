...
from wowadis_muilt_withcovmat_marginalH0 import  (log_likelihood,worker_run_gussian_om0_with_H0,
...
def worker_run_gussian_om0_with_H0_and_CMB(args):
    ...
    h0_initial = params[3]
    model_m = params[4]  # for making sure we have this here
