...
from wowadis_muilt_withcovmat_marginalH0 import log_likelihood,worker_run_gussian_om0_with_H0,hessian_neg_log_posterior,type_to_lcdm,run_lcdm_methods_om0_by_multiprocessing, worker_run_methods_om0_with_H0
from cmb_v1 import CMBParams, set_astropy_cosmology, calculate_z_star,la_rzs_from_cosmoparams
...
def run_lcdm_methods_om0_with_cmb_by_multiprocessing(param_combinations, z, data_err):
